...
int main(int argc, char *argv[])
{
    ...
    string in_file_name = "C:\\WorkSpace\\mytest\\tjh_test\\opencv_test\\6_QR_code_detection\\QR2.png";
...
void drawFPS(Mat &color_image, double fps)
{
    ...
    putText(color_image, convert.str(), Point(25, 25), FONT_HERSHEY_DUPLEX, 2, Scalar(0, 0, 255), 2);
}
